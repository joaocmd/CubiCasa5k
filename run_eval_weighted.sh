...
for FILE in "dfp" "dfp-last-conv" "dfp-resnet34" "dfp-resnet50" "deeplabv3" "dfp-resnet34-encoder-conv"
do 
...
python eval.py --arch "dfp-resnet50" --weights "experiment2-weighted-loss/dfp-resnet50/model_best_val_loss_var.pkl" --output-dir "output/results/experiment2-weighted-loss/dfp-resnet50"
python eval.py --arch "dfp-resnet34" --weights "experiment2-weighted-loss/dfp-resnet34/model_best_val_loss_var.pkl" --output-dir "output/results/experiment2-weighted-loss/dfp-resnet34"
