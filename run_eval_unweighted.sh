...
# python eval.py --arch "$FILE" --weights "experiment1-uncertainty-loss/$FILE/model_best_val_loss_var.pkl" --output-dir "output/results/experiment1-uncertainty-loss/$FILE"
